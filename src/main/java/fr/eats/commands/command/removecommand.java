...
public class removecommand {
	...
	private void removeboisson(Message msg) {
		if (!Documents.doc.removeBoisson(msg.getContentRaw().split(" ")[1]))
	...
	private void removemeal(Message msg) {
		if (!Documents.doc.removeMeals(msg.getContentRaw().split(" ")[1]))
	...
	private void removesnack(Message msg) {
		if (!Documents.doc.removeSnack(msg.getContentRaw().split(" ")[1]))
